...
const Util = {
  ...
  timeLeft(pos){
    ...
    console.log(100 - (distFrom/500)*50, "new time");

    return 100;
    // return ( 100 - (distFrom/500)*70);
  }
};
...
class Game {
  ...
  addBuildings(){
    ...
    for(let i = 0; i < Game.NUM_BUILDINGS; i++){
      ...
      if(i >= Game.NUM_BUILDINGS/2){ j = 230; }

      const building = new Building(
        { pos: [i*100 + 100 + j , 375], width: 60, height: 100, color: '#32CD32', game: this }
      );
